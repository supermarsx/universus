...
- Baseline regression coverage now exists in `crates/platform-worker-runtime/tests/runtime_regression.rs` (leak counter reset, max in-flight backpressure, shutdown rejection).  
