...
CREATE INDEX IF NOT EXISTS idx_universe_type ON universe_seeds(universe_type);
CREATE INDEX IF NOT EXISTS idx_universe_seeded ON universe_seeds(is_seeded);
...
CREATE INDEX IF NOT EXISTS idx_galaxy_universe ON galaxy_seeds(universe_id);
CREATE INDEX IF NOT EXISTS idx_galaxy_type ON galaxy_seeds(galaxy_type);
CREATE INDEX IF NOT EXISTS idx_galaxy_generated ON galaxy_seeds(is_generated);
...
CREATE INDEX IF NOT EXISTS idx_sector_galaxy ON sector_configurations(galaxy_id);
CREATE INDEX IF NOT EXISTS idx_sector_tier ON sector_configurations(difficulty_tier);
...
CREATE INDEX IF NOT EXISTS idx_placement_rules_universe ON player_placement_rules(universe_id);
CREATE INDEX IF NOT EXISTS idx_placement_active ON player_placement_rules(is_active);
...
CREATE INDEX IF NOT EXISTS idx_placement_user ON player_placements(user_id);
CREATE INDEX IF NOT EXISTS idx_placement_location ON player_placements(galaxy, system, position);
CREATE INDEX IF NOT EXISTS idx_placement_universe ON player_placements(universe_id);
...
CREATE INDEX IF NOT EXISTS idx_bot_template_universe ON bot_generation_templates(universe_id);
CREATE INDEX IF NOT EXISTS idx_bot_template_personality ON bot_generation_templates(bot_personality);
...
CREATE INDEX IF NOT EXISTS idx_generated_bot_universe ON generated_bots(universe_id);
CREATE INDEX IF NOT EXISTS idx_generated_bot_user ON generated_bots(user_id);
CREATE INDEX IF NOT EXISTS idx_generated_bot_active ON generated_bots(is_active);
CREATE INDEX IF NOT EXISTS idx_generated_bot_location ON generated_bots(galaxy, system, position);
...
CREATE INDEX IF NOT EXISTS idx_resource_pattern_galaxy ON resource_distribution_patterns(galaxy_id);
CREATE INDEX IF NOT EXISTS idx_resource_pattern_type ON resource_distribution_patterns(pattern_type);
...
CREATE INDEX IF NOT EXISTS idx_planet_resources_location ON planet_resources(galaxy, system, position);
CREATE INDEX IF NOT EXISTS idx_planet_resources_strategic ON planet_resources(strategic_value);
...
CREATE INDEX IF NOT EXISTS idx_alliance_seed_universe ON alliance_seeds(universe_id);
CREATE INDEX IF NOT EXISTS idx_alliance_seed_formed ON alliance_seeds(is_formed);
...
CREATE INDEX IF NOT EXISTS idx_maintenance_universe ON universe_maintenance_tasks(universe_id);
CREATE INDEX IF NOT EXISTS idx_maintenance_active ON universe_maintenance_tasks(is_active, next_run_at);
CREATE INDEX IF NOT EXISTS idx_maintenance_type ON universe_maintenance_tasks(task_type);
...
CREATE INDEX IF NOT EXISTS idx_analytics_universe ON universe_analytics(universe_id);
CREATE INDEX IF NOT EXISTS idx_analytics_date ON universe_analytics(snapshot_date DESC);
...
SELECT
    ...
    COUNT(DISTINCT gb.user_id) as active_bot_count,
...
DROP TRIGGER IF EXISTS universe_seeds_updated_at ON universe_seeds;
...
DROP TRIGGER IF EXISTS galaxy_seeds_updated_at ON galaxy_seeds;
CREATE TRIGGER galaxy_seeds_updated_at
    BEFORE UPDATE ON galaxy_seeds
    FOR EACH ROW EXECUTE FUNCTION update_universe_timestamp();

DROP TRIGGER IF EXISTS bot_templates_updated_at ON bot_generation_templates;
CREATE TRIGGER bot_templates_updated_at
    BEFORE UPDATE ON bot_generation_templates
    FOR EACH ROW EXECUTE FUNCTION update_universe_timestamp();

DROP TRIGGER IF EXISTS alliance_seeds_updated_at ON alliance_seeds;
...
-- =====================================================
-- PHASE 4.1: ADVANCED UNIVERSE LIFECYCLE EXTENSIONS
-- Restored alongside the original Phase 4 schema.
-- =====================================================
